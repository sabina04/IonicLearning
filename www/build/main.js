...
var Api = /** @class */ (function () {
    function Api(http) {
        this.http = http;
        this.url = 'http://localhost:4343/api/v1';
    }
    ...
    Api.prototype.validateToken = function (res) {
        return true;
    };
    Api = __decorate([
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__providers__ = __webpack_require__(55);
...
var User = /** @class */ (function () {
    ...
    User.prototype.login = function (accountInfo) {
        var _this = this;
        var seq = this.api.post('users/login', accountInfo).share();
    ...
    User.prototype.logout = function () {
        var seq = this.api.post('users/logout', { 'data': 'data' }, { headers: new __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["c" /* HttpHeaders */]().set('token', localStorage.getItem('token')) }).share();
        seq.subscribe(function (res) {
            //return res;
        }, function (err) {
            console.error('ERROR', err);
    ...
    User.prototype.forgotUsername = function (emailId) {
        var seq = this.api.post("users/recoveryAccountDetail", emailId).share();
        return seq;
    };
    User = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["A" /* Injectable */])(),
...
var MyApp = /** @class */ (function () {
    function MyApp(toastCtrl, user, alertCtrl, menuCtrl, translate, platform, settings, config, statusBar, splashScreen) {
        var _this = this;
    ...
    MyApp = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["n" /* ToastController */], __WEBPACK_IMPORTED_MODULE_6__providers__["d" /* User */], __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["h" /* MenuController */], __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["c" /* TranslateService */], __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["m" /* Platform */], __WEBPACK_IMPORTED_MODULE_6__providers__["c" /* Settings */], __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["b" /* Config */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_status_bar__["a" /* StatusBar */], __WEBPACK_IMPORTED_MODULE_1__ionic_native_splash_screen__["a" /* SplashScreen */]])
    ], MyApp);
    return MyApp;
}());
